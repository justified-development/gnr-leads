...
def run(*args):
    scraped_leads = []
    scraped_leads.append(ScrapedLead('Illinois', 'test_username', '10/25/2021', '5m 0s', '10m 0s', None))
    scraped_leads.append(ScrapedLead('Arizona', 'test_username2', '10/25/2021', '7m 0s', '12m 0s', None))
